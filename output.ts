...
const CardDataSchema = new Schema({
  ...
  cardFaces: { type: [CardDataFaceSchema] },
...
export const CardDataModel: Model<CardData> = mongoose.model<CardData>(
  "CardData",
  CardDataSchema
);
...
export const DeckModel: Model<Deck> = mongoose.model<Deck>("Deck", DeckSchema);
